...
expName = 'GPHD'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\ruccs_lab\\Desktop\\GPHD_demo\\GPHD.py',
...
text = visual.TextStim(win=win, name='text',
    text='Hello! This experiment demontrates how to interface your GP eye-tracker with the lovely PsychoPy Builder.  ',
    font='Open Sans',
...
#make sure the constraints.py file is in experiment folder

import os
from constants import DISPTYPE, DISPSIZE, TRACKERTYPE, BGC, FGC
